...
use Axytos\KaufAufRechnung_OXID6\Adapter\HashCalculation\HashAlgorithmInterface;

class HashCalculator
{
    /**
     * @var \Axytos\KaufAufRechnung_OXID6\Adapter\HashCalculation\HashAlgorithmInterface
     */
